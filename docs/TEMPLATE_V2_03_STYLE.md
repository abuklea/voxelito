...
<inspirations>
The attached images (if any) may serve as inspiration for the visual design, style, vibe, layout, and presentation. 
*Note:* Not to be taken literally, but use a reference to inspire the project design and target aesthetic.
</inspirations>
<aesthetics>
...
- Card styling
- Input styling
- Other/additional/advanced components
- Banners, icons, and imagery 
- Layout and component spacings
- Motion and animation
- Visual Effects

Important: Take this all into account, and develop a cohesive Style Guide. Here’s an EXAMPLE _format_ of how I want it formatted (use to structure a new custom style guide for the project, and add any further detail as required:
...
- Typography
	...
	- Text Styles
		...
		- Link Text
			- 15px/20px, Medium, Letter spacing 0px, Primary Dark Green
